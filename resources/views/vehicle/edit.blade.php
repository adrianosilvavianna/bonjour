            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <form action="{{ route('user.vehicle.update', $vehicle) }}" method="post" id="form-vehicle" data-vehicle="{{ $vehicle->id }}" >
                            {{ method_field('PUT') }}
                            <div class="col-md-12">
                            ...
                            <div class="cold-md-12">
                                <div class="col-md-3 {{ $errors->has('year') ? ' has-error' : '' }}">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="number" name="year" id="year" class="form-control" value="2016" min="1980" max="{!! date('Y') !!}" value="{{ $vehicle->year }}">
                                    </div>
                                    @if ($errors->has('year'))
                                        <span class="help-block">
                                ...
                                <div class="col-md-3 {{ $errors->has('plaque') ? ' has-error' : '' }}">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="plaque" id="plaque" class="form-control" value="{{ $vehicle->plaque }}">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="number" name="num_passenger" id="num_passenger" class="form-control" value="{{ $vehicle->num_passenger }}" min="1" max="10">
                                    </div>
                                </div>
                            </div>
